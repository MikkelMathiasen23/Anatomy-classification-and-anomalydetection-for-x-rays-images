...
scheduler = lr_scheduler.ReduceLROnPlateau(optimizer_ft, mode = 'min', patience=10, verbose =True )
...
save_model_all(model_ft, '../saved_models/DenseNet_v2_e30', 'DenseNet', 30)

#-------------------------------------------------------------------------------------
# Creating text files and writing data to them
os.chdir('../saved_models/DenseNet_v2_e30')
