...
if torch.cuda.device_count() > 1:
	...
	state_dict = torch.load('../saved_models/DenseNet_roi_e30/DenseNet_epoch_30.pt')
...
save_model_all(model_ft, '../saved_models/DenseNet_roi_ft_e100', 'DenseNet', 100)

#-------------------------------------------------------------------------------------
# Creating text files and writing data to them
os.chdir('../saved_models/DenseNet_roi_ft_e100')
