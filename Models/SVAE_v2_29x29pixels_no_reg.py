...
class VAE_Conv(nn.Module):
	...
	def __init__(self, z_dim=200, img_channels=1, img_size=224):
		...
		self.decoder = nn.Sequential(
			...
			nn.ReLU(),
			nn.ConvTranspose2d(32, 16, (5,5), stride=1, padding=2),
			nn.ReLU(),
			nn.ConvTranspose2d(16,8, (5,5), stride = 2, padding = 2),
			nn.ReLU(),
			nn.ConvTranspose2d(8,8, (4,4), stride = 2, padding = 2),
			nn.ReLU(),
			nn.ConvTranspose2d(8, img_channels, (5,5), stride=1, padding=2),
			nn.Sigmoid()
		)
...
save_model_all(model, '../saved_models/SVAE_v2_29x29pixels_e50', 'SVAE', 100)

# Creating text files and writing data to them
os.chdir('../saved_models/SVAE_v2_29x29pixels_e50')
...
_save_latents('../saved_models/SVAE_v2_29x29pixels_e50',dataloaders)