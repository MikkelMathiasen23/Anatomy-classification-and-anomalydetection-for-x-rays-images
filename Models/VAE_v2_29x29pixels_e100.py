...
save_model_all(model, '../saved_models/VAE_v2_29x29pixels_e100', 'VAE', 100)

# Creating text files and writing data to them
os.chdir('../saved_models/VAE_v2_29x29pixels_e100')
...
_save_latents('../saved_models/VAE_v2_29x29pixels_e100',dataloaders)
