...
if torch.cuda.device_count() > 1:
	...
	state_dict = torch.load('../saved_models/DenseNet_v2_e50/DenseNet_epoch_50.pt')
...
scheduler = lr_scheduler.ReduceLROnPlateau(optimizer_ft, mode = 'min', patience=5, verbose =True )
...
save_model_all(model_ft, '../saved_models/DenseNet_v2_ft_e100', 'DenseNet', 100)

#-------------------------------------------------------------------------------------
# Creating text files and writing data to them
os.chdir('../saved_models/DenseNet_v2_ft_e100')
